...
| P10  | 院内通讯录                                                                                                                          | `miniprogram-parity-p10-directory--department-390` / `--employee-390` / `--department-320` / `--employee-desktop-1280`                                                                                                                                                                                                                | `UnifiedDirectoryView` 生产组件；合成数据；科室/人员模式；搜索/七级筛选/权限/号码展示；状态契约见 P10 fixture                                                      | 已固化           | 已固化               | 待人工测试        | 已授权原生实现；待实体测试                         |
