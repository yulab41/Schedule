...
| P10-A4 | 主包 `pages/profile/index` 原生个人中心                                                                        | Web `web-ui-2-0-production-·-我的--mobile` / `--desktop`                                                                 | 登录态姓名/认证方式/解绑/切换/退出；未登录空态与大字号；不读取真实业务统计                                                                 | Web 已固化       | Web 已固化           | 待人工测试        | 原生体验版待验收 |
