...
| P9-A8 | `client-core` 通知中心与导出任务 JSON 边界                                                            | 原生页面待实现；对照 `miniprogram-parity-p9-insights-suite--notifications-ready-390` / `--export-ready-390`                                                                                   | 通知列表/未读/已读、导出任务创建/状态；二进制下载留给 Mini platform adapter，不进入共享包                                                        | Web 黄金已固化 | Web 黄金已固化      | 待人工测试       | 共享 JSON 边界已完成；待 runtime/native 页面 |
| P9-A9 | Mini runtime 通知/导出任务 transport bridge                                                            | 原生页面待实现；复用 P9-A8 `P9InsightsActionsClient`                                                                                                                                             | `insights` capability、Bearer transport、通知/导出 JSON 任务；二进制下载仍不在本批                                                                 | Web 黄金已固化 | Web 黄金已固化      | 待人工测试       | runtime bridge 已完成；待原生页面与实体机验收 |
