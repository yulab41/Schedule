...
| Audit-T1     | `subpackages/diagnostics/pages/test-tools/index` 安全测试工具                                                                       | `miniprogram-audit-test-tools--ready-390` / `--ready-320` / `--large-text-390`                                                                                                                                                                                                                                                        | develop/trial；构建校准条、设备/安全区、显示检查、通讯录性能诊断、场景、脱敏网络、错误指纹、存储摘要、复制报告；release 三层失败关闭                                        | 已截图；无横溢    | 已截图；无横溢       | 待小米 14 体验版复核 | Web 黄金仅辅助，最终以匹配 SHA 的小米 14 体验版为准         |
