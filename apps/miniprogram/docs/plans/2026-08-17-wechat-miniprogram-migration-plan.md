...
- 状态：P0–P7 已完成；P7 `.94@0975b2d` 于 2026-08-25 获得用户实体 Android 明确通过；P8 组织管理、P10 通讯录/个人中心及 P9 数据/消息原生切片均已完成自动回归、体验上传、生产 verifier 与状态矩阵收口，用户已明确本轮无需人工复核。生产 `organization=true` 已保持生效，`insights/externalMessages` 继续关闭；开启 P9 能力、订阅消息或提交审核/正式发布仍需用户明确授权，不由自动验收推断。
