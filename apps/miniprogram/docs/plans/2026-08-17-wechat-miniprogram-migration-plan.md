...
- 状态：P0–P7 已完成；P7 `.94@0975b2d` 于 2026-08-25 获得用户实体 Android 明确通过；用户已确认 P8 组织管理、P10 通讯录和 P10 个人中心 RC 通过，且已授权并完成生产 `organization=true` 原子切换。P9 数据/消息原生切片仍待独立实体复核，`insights/externalMessages` 继续关闭。
