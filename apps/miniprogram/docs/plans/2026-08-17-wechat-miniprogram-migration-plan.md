...
- 状态：P0–P7 已完成；P7 `.94@0975b2d` 于 2026-08-25 获得用户实体 Android 明确通过；用户已确认 P8 组织管理、P10 通讯录和 P10 个人中心 RC 通过。P8/P10 代码与体验版验收已完成，但生产 `organization=false` 仍保持关闭，待明确授权后再做原子能力切换；P9 数据/消息原生切片仍待独立实体复核，`insights/externalMessages` 继续关闭。
