...
- 状态：P0、P1 与 P2 已完成。P1 基础控件、动态月历、7×7 和 20×30 矩阵已于 2026-08-22 通过用户实体 Android 验收；P2 已完成 Web 先行的日历、手排 transition/选择/撤销、发布生命周期共享，以及月历 JSON client/decoder/`wx.request` transport、tokens、黄金 fixtures 和 Mini bundle 门禁。下一阶段只从 P3 身份安全预检开始。
