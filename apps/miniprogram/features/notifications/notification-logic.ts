...
export function getNotificationCardViewModel(
  ...
  return {
    ...
    time: formatNotificationTime(notification.createdAt, now),
    title: notification.title,
  };
}

export function parseReminderHoursInput(value: string): readonly number[] {
  const tokens = value
    .split(/[,，、\s]+/u)
