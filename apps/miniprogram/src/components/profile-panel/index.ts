...
Component({
  ...
  methods: {
    ...
    handleContactBlur: controller.handleContactBlur,
    handleContactClose: controller.handleContactClose,
    handleContactFocus: controller.handleContactFocus,
    ...
    handleMobilePhoneEdit: controller.handleMobilePhoneEdit,
    ...
    handleShortPhoneEdit: controller.handleShortPhoneEdit,
