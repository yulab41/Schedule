...
export const MINI_TELEMETRY_BOUNDARY_MARKERS = [
  'directory:controller-attached',
  'directory:page-onload',
  'duty:controller-onload',
  'duty:page-onload',
  'exports:component-attached',
  'exports:page-onload',
  'exports:page-ready',
  'exports:options-start',
  'exports:options-ready',
  'exports:options-error',
  'exports:options-timeout',
  'group-settings:controller-onload',
  'group-settings:page-onload',
  'insights:component-attached',
  'insights:page-onload',
  'invite-visitor:controller-attached',
  'invite-visitor:page-onload',
  'leave:controller-onload',
  'leave:page-onload',
  ...
  'platform-accounts:controller-attached',
  'platform-accounts:page-onload',
  'scheduling-config:controller-attached',
  'scheduling-config:page-onload',
  'swap:controller-onload',
  'swap:page-onload',
