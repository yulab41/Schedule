...
const productionSources = [
  ...
  new URL('../src/directory-read-client.ts', import.meta.url),
  new URL('../src/endpoint.ts', import.meta.url),
  new URL('../src/error.ts', import.meta.url),
  new URL('../src/json-decoder.ts', import.meta.url),
  new URL('../src/qr-visitor-write-client.ts', import.meta.url),
  new URL('../src/manual-schedule-client.ts', import.meta.url),
  new URL('../src/mobile-phone-consent-client.ts', import.meta.url),
  new URL('../src/notification-preferences-client.ts', import.meta.url),
  new URL('../src/organization-read-client.ts', import.meta.url),
  new URL('../src/organization-write-client.ts', import.meta.url),
  new URL('../src/past-schedule-client.ts', import.meta.url),
  new URL('../src/platform-account-client.ts', import.meta.url),
  new URL('../src/platform-identity-write-client.ts', import.meta.url),
  ...
  it('bundles for a browser runtime without pulling contracts or another dependency graph', async () => {
    ...
    expect(bundledInputs).toEqual(
      [
        ...
        'packages/client-core/src/qr-visitor-write-client.ts',
        ...
        'packages/client-core/src/notification-preferences-client.ts',
        'packages/client-core/src/organization-read-client.ts',
        'packages/client-core/src/organization-write-client.ts',
        'packages/client-core/src/past-schedule-client.ts',
        'packages/client-core/src/platform-account-client.ts',
