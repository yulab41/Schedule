...
小米 14 双实例复核；自动化结果不构成原生验收。实现检查点本身未上传、未部署；随后用户在当次
消息授权“上传并放行”，交付记录见
[runtime-ui-compatibility-picker-inline-trial-release-20260915.md](runtime-ui-compatibility-picker-inline-trial-release-20260915.md)。
