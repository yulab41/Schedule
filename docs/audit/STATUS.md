...
## 当前批次：feedback8 服务端交付完成，待体验版上传与真机复核
...
- 使用独占general-1复用工作区依赖。原35账户/24设密码/11待设置；用户确认新范围3账户及影响后已完成备份、删除及生产验证，现32/24/8、4011排班归属保留。清理见feedback8-account-cleanup.md；应用8e68a480已推送并部署生产，交付见feedback8-server-release.md。未主动发送通知或上传本轮体验版。
...
- 唯一下一任务与停止条件：UPLOAD_REQUIRED，取得当前干净提交的体验版上传和新增版本放行授权，完成上传及只追加允许列表；之后用户在小米14验证视觉、邀请分享和本人收信。尚未分配新版号或上传，不提审/正式发布，不重做账户清理或部署应用。
