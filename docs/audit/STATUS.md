...
- Mini 全量 `1280 passed / 18 skipped`、根 `1306 passed / 451 skipped`、production verify、格式和开发者工具 WXML/WXSS 编译通过。模拟器首页停在排班读取，真实排班视觉和小米 14 未验证；当前修复尚未上传。
