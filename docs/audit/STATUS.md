...
- 规格见 [手动排班预览与访客审计去重设计](../superpowers/specs/2026-09-23-manual-preview-visitor-audit-followup-design.md)。当前停止条件是完成书面规格复核；通过后再进入测试先行、生产部署、体验版上传与只追加放行。未提审、未正式发布。
