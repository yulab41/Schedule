...
- 交付：`91b19bcf` 已推送；动态分配并上传体验版 `0.1.0-p10.20260920.184`，Manifest `407a236f0509c82ca77ddd5e311d9ac934cec05c94573f4da20aeabfe621bb33`，远端不可变 tag、allocation、manifest 与 receipt 一致。可信 allowlist `ensure` 只追加 `.184`，独立 verify 通过；公网 `.184`/`.183`=200、未知版=426、health=200。线上 release 仍为 `bc5fc307`，未提审、未正式发布、未部署 API/Web。
