...
- 唯一下一任务/停止条件：用户在小米14打开体验版`0.1.0-p10.20260919.175`，确认150ms连续快速左滑5–6次前进5–6个月、月/周视图不回退、换月内容出现更快；未取得与`17b63aa2`一致的真机结论前，不得写“小米14验收通过”。详情见`docs/debug/debug-feedback-log.md`2026-09-19第五条。
