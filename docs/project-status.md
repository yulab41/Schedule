...
- 生产能力/体验：备份 `b78654b6-f599-4dd7-8619-919e96d9d57b`（54 表、176,868 行、81,712,736 bytes、SHA-256 `28a45630ab7dcf23fb48e52075c62f4a3bded08b69ea205a8bfdf67d141953eb`）保护能力切换；`insights=true`、`externalMessages=true` 已通过双锁策略探针。`.38` 体验版上传成功（153 个代码文件、zip `1,404,386` bytes、上传 manifest `faf80861587f5a10a9b95fe2b2dad4983c2df22785e605d3fd8dafb9b54d23d8`）并已加入白名单；ECS checkpoint `f1e45fe5` 已在备份 `55184e32-c479-4e83-9714-ad915467fb0d` 后部署，完整 verifier、`.38` 探针、`root:root/0600` 和临时目录清理均通过。
