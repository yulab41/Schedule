...
- 正式发布：代码 checkpoint `0aaa562`（`fix(web): stabilize mobile calendar controls and corners`）已推送；发布前加密数据库备份 archive 为 `1e04e2cc-4d73-4f85-9033-9227aa6776767`（44 张表、111142 行、4,271,268 字节，SHA-256 `1bd1d9e97244c3646f7ff1066ed2bb70aa098f1a66e596dcda10807562278c38`）。release `0aaa5620616cda90dbd863656adb4ac0ae5c8c82` 部署成功，发布前后 `ecs-verify.sh` 均通过；首次域名健康检查在容器预热时出现一次 502，自动重试后全部核验通过。
