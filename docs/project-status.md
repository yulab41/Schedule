...
- 发布/下一步：生产备份 archive `2a1bad2d-2c6a-4488-9d2c-5a73adb7e174`（54 表/169,494 行/79,170,768 bytes/SHA `d7e5fd27936a33d0ae3fd681439b1a35c6e82cc53e27afef7160ff27036c3bb9`）后部署 release `ddd5c1077b015a346d060b6c879235a18d5fefdc`；预热一次 502 后恢复，`ECS_PUBLIC_IP` full `ecs-verify.sh`、health 200、`.94 organization=false`、artifact/control-plane/migration/unknown-host 检查通过，远端临时目录已清理。最终状态 checkpoint 识别消息为 `docs(status): record p8 invite visitor deployment`。下一批为 P8-E 平台账号后台，停止条件是先取得本批邀请/访客页面用户复核；未提审、未正式发布、未开放 capability。
